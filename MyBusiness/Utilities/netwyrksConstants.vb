...
#Region "constants"
    ...
    Public Const PASSWORD_CHANGE_EMAIL As String = _
        "A temporary password has been requested for you for SERS." & vbCrLf & _
        "Temporary password: {}" & vbCrLf & _
        "You can still use your old password." & vbCrLf & vbCrLf & _
        "You will be required to choose a new password when you login." & vbCrLf & vbCrLf & _
        "SERS Adminstration" & vbCrLf
    Public Const SKIN_OPT1 As String = "imageButtons"
    Public Const SKIN_STD As String = "standard"
    Public Const SHOP_LIST_CACHE_FILE As String = "shoplistcache"
    ...
    Public Const TANDC_SUBJECT = "Self-exclusion Terms and Conditions"
    Public Const TANDC_TEMPLATE_NAME As String = "Terms and Conditions"
#End Region
End Module
